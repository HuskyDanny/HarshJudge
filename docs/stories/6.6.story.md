...
- [ ] Task 1: Update SKILL.md with agent patterns (AC: 1)
  - [ ] Open `skills/harshjudge/SKILL.md`
  - [ ] Add "Agent Spawning Pattern" section (content from agent-pattern.md)
  - [ ] Add "Token Optimization" subsection
  - [ ] Update "Core Principles" to remove iterations.md reference
  - [ ] Update "Project Structure" to show new steps/ layout
  - [ ] Update MCP tools quick reference:
    - Add `createScenario` (replaces saveScenario)
    - Add `completeStep` (new)
    - Add `toggleStar` (new)
    - Update `recordEvidence` (now takes stepId)
  - [ ] Update workflow table to reference updated files

- [ ] Task 2: Update run.md with Playwright tools (AC: 2)
  - [ ] Open `skills/harshjudge/references/run.md`
  - [ ] Add "Playwright MCP Tools Reference" section (content from playwright-tools.md)
  - [ ] Include element reference format (ref=eN)
  - [ ] Include common tool patterns (navigate, click, type, screenshot)
  - [ ] Update workflow for step-based execution (from Story 6.5)
  - [ ] Update evidence paths for per-step structure

- [ ] Task 3: Delete redundant reference files (AC: 3)
  - [ ] Delete `skills/harshjudge/references/agent-pattern.md`
  - [ ] Delete `skills/harshjudge/references/playwright-tools.md`
  - [ ] Verify no broken references in other skill files

- [ ] Task 4: Delete iterations.md asset (AC: 1)
  - [ ] Delete `skills/harshjudge/assets/iterations.md`
  - [ ] Update any references in other skill files

- [ ] Task 5: Update create.md for createScenario (AC: 4)
  - [ ] Open `skills/harshjudge/references/create.md`
  - [ ] Replace `saveScenario` tool usage with `createScenario`
  - [ ] Update input format to use steps array instead of content string
  - [ ] Update example with step-based structure
  - [ ] Add note about starred field

- [ ] Task 6: Update setup.md for new structure (AC: 5)
  - [ ] Open `skills/harshjudge/references/setup.md`
  - [ ] Update project structure diagram to show prd.md and steps/
  - [ ] Update initProject result to show prdPath
  - [ ] Remove references to iterations.md

- [ ] Task 7: Update status.md for starred filter (AC: 1)
  - [ ] Open `skills/harshjudge/references/status.md`
  - [ ] Add `starredOnly` parameter usage
  - [ ] Update example responses to include starred field

- [ ] Task 8: Update iterate.md for step-based editing (AC: 5)
  - [ ] Open `skills/harshjudge/references/iterate.md`
  - [ ] Update to edit individual step files
  - [ ] Update evidence paths for per-step structure
  - [ ] Remove iterations.md references

- [ ] Task 9: Verify final skill structure (AC: 5)
  - [ ] Confirm file tree matches AC 5
  - [ ] Test that skill activates correctly in Claude Code
