...
export class DashboardServer {
   ...
   * Handle API requests
   */
  private async handleApiRequest(url: string, res: ServerResponse): Promise<void> {
  ...
  private async readScenarioMeta(scenarioPath: string): Promise<ScenarioMetaV2 | null> {
    try {
