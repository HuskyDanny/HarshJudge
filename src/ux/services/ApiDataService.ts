...
export interface RunDetail {
  runId: string;
  scenarioSlug: string;
  result: import('../../types/index.js').RunResult | null;
...
export class ApiDataService {
  ...
  async getScenarioDetail(
    ...
    return this.fetchJson<ScenarioDetail | null>(
      `/projects/${encodedProject}/scenarios/${encodedScenario}`
    );
  }
  ...
  async getRunHistory(
    ...
    const encodedProject = encodeURIComponent(projectPath);
    const encodedScenario = encodeURIComponent(scenarioSlug);
    return this.fetchJson<RunSummary[]>(
      `/projects/${encodedProject}/scenarios/${encodedScenario}/runs`
    );
  }
  ...
  async getRunDetail(
    ...
    return this.fetchJson<RunDetail | null>(
      `/projects/${encodedProject}/scenarios/${encodedScenario}/runs/${encodedRun}`
    );
  }
}
